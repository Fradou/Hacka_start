...
class DemandController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $demands = $em->getRepository('TransBundle:Demand')->findAll();
    ...
    {
        $demand = new Demand();
        $form = $this->createForm('TransBundle\Form\DemandType', $demand);
    ...
    {
        $deleteForm = $this->createDeleteForm($demand);
        $editForm = $this->createForm('TransBundle\Form\DemandType', $demand);
